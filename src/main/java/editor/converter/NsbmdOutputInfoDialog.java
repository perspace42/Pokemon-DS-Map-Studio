                    ...
                    jpDisplayLayout.setHorizontalGroup(
                            jpDisplayLayout.createParallelGroup()
                                    .addGroup(jpDisplayLayout.createSequentialGroup()
                                            .addContainerGap()
                                            .addComponent(nitroDisplayGL1, GroupLayout.DEFAULT_SIZE,
                            ...
                            jpErrorInfoLayout.createParallelGroup()
                                    .addGroup(jpErrorInfoLayout.createSequentialGroup()
                                            ...
                                            .addGroup(jpErrorInfoLayout.createParallelGroup()
                                                    .addComponent(jScrollPane2, GroupLayout.DEFAULT_SIZE, 0,
                                                            Short.MAX_VALUE)
                                                    .addGroup(jpErrorInfoLayout.createSequentialGroup()
            ...
            if (!Thread.currentThread().isInterrupted()) {
                ...
                try {
                    ...
                    if (System.getProperty("os.name").toLowerCase().startsWith("windows")) {
                        ...
                        imdPath = new File(cwd).toURI().relativize(new File(pathOpen).toPath().toRealPath().toUri())
                                .getPath(); // this is some serious java shit
                    }
                    ...
                    try {
                        ...
                        if (includeNsbtx) {
                            ...
                            cmd = new String[] { "python", converterPath, imdPath, "-emdl", "-o", filename };
                        }
