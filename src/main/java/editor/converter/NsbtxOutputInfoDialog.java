                        ...
                        jPanel2Layout.createParallelGroup()
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addGroup(jPanel2Layout.createParallelGroup()
                                                .addComponent(jScrollPane1, GroupLayout.DEFAULT_SIZE, 447,
                                                        Short.MAX_VALUE)
                                                .addGroup(jPanel2Layout.createSequentialGroup()
                                                        .addComponent(jLabel5)
                                                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                                        .addComponent(jlResult, GroupLayout.DEFAULT_SIZE,
                                                ...
                                                .addGroup(jPanel2Layout.createSequentialGroup()
                                                        ...
                                                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                                        .addComponent(jProgressBar1, GroupLayout.DEFAULT_SIZE, 290,
                                                                Short.MAX_VALUE)))
                                        .addContainerGap()));
                jPanel2Layout.setVerticalGroup(
                        jPanel2Layout.createParallelGroup()
                                .addGroup(jPanel2Layout.createSequentialGroup()
                                        ...
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                .addComponent(jLabel4, GroupLayout.PREFERRED_SIZE, 14,
                                                        GroupLayout.PREFERRED_SIZE)
                                                .addComponent(jlFilesConverted))
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.RELATED)
                                        .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                                                .addComponent(jLabel8, GroupLayout.PREFERRED_SIZE, 14,
                                                        GroupLayout.PREFERRED_SIZE)
                                                .addComponent(jlFilesNotConverted))
                                        .addPreferredGap(LayoutStyle.ComponentPlacement.UNRELATED)
                                        .addGroup(jPanel2Layout.createParallelGroup(GroupLayout.Alignment.BASELINE)
                ...
                // ======== jpDisplay ========
                {
                    ...
                    jpDisplayLayout.setVerticalGroup(
                            jpDisplayLayout.createParallelGroup()
                                    .addGroup(jpDisplayLayout.createSequentialGroup()
                                            .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                            .addComponent(nsbtxPanel1, GroupLayout.DEFAULT_SIZE,
                                                    GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)
                                            .addContainerGap(GroupLayout.DEFAULT_SIZE, Short.MAX_VALUE)));
                }
                            ...
                            jpErrorInfoLayout.createParallelGroup()
                                    .addGroup(jpErrorInfoLayout.createSequentialGroup()
                                            ...
                                            .addGroup(jpErrorInfoLayout.createParallelGroup()
                                                    .addComponent(jScrollPane2, GroupLayout.DEFAULT_SIZE, 399,
                                                            Short.MAX_VALUE)
                                                    .addGroup(jpErrorInfoLayout.createSequentialGroup()
